...
namespace ESIDIFAcumuladores.Business
{
    public class Sources
    {
        ...
        public Models.acumuladoresCreditoConsulta generarCrgOvWeb(Models.imputacionCreditoConsulta data)
        {
            ...
            try
            {
                ...
                var resp = Functions.DeserializeXMLFileToObject<Models.acumuladoresCreditoConsulta>(result);
